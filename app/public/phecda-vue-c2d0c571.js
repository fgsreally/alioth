...
import { s as me, a as ge, m as Ee, t as Tt, e as Oe, i as Pe, o as Me, w as Se, f as be, j as Te, k as At } from "./vue.runtime.esm-bundler-57682e21.js";
var Ae = Object.defineProperty, je = Object.getOwnPropertyDescriptor, jt = (e, t, n, r) => {
  for (var i = r > 1 ? void 0 : r ? je(t, n) : t, u = e.length - 1, c; u >= 0; u--)
    (c = e[u]) && (i = (r ? c(t, n, i) : c(i)) || i);
  return r && i && Ae(t, n, i), i;
}, j = Symbol("phecda"), y = Symbol("phecda");
function en(e) {
...
function S(e, t) {
  t || (t = j, e = e.prototype), D(e), e[y].__STATE_KEY.add(t), It(e, t);
}
function It(e, t) {
  t || (t = j, e = e.prototype), D(e), e[y].__EXPOSE_KEY.add(t);
}
function Ie(e, t) {
  t || (t = j, e = e.prototype), D(e), e[y].__IGNORE_KEY.add(t);
}
function T(e, t, n) {
  t || (t = j, e = e.prototype), D(e), e[y].__STATE_HANDLER__.has(t) ? e[y].__STATE_HANDLER__.get(t).push(n) : e[y].__STATE_HANDLER__.set(t, [n]);
}
function Rt(e, t, n) {
  t || (t = j, e = e.prototype), D(e), e[y].__STATE_NAMESPACE__.set(t, n);
}
function nn(e) {
...
function fn(e, t) {
  t || (e = e.prototype, t = j), Ie(e, t);
}
function cn(e, t) {
  t || (e = e.prototype, t = j), D(e), e[y].__CLEAR_KEY.add(t);
}
function hn(e, t) {
  It(e, t);
}
...
function Ln({ key: e, json: t, stringify: n } = {}) {
...
(function(e) {
  (function(t) {
    var n = typeof St == "object" ? St : typeof self == "object" ? self : typeof this == "object" ? this : Function("return this;")(), r = i(e);
    typeof n.Reflect > "u" ? n.Reflect = e : r = i(n.Reflect, r), t(r);
    function i(u, c) {
      return function(p, g) {
        typeof u[p] != "function" && Object.defineProperty(u, p, { configurable: !0, writable: !0, value: g }), c && c(p, g);
      };
    }
  })(function(t) {
    var n = Object.prototype.hasOwnProperty, r = typeof Symbol == "function", i = r && typeof Symbol.toPrimitive < "u" ? Symbol.toPrimitive : "@@toPrimitive", u = r && typeof Symbol.iterator < "u" ? Symbol.iterator : "@@iterator", c = typeof Object.create == "function", p = { __proto__: [] } instanceof Array, g = !c && !p, Y = {
    ...
    function Ft(a, o, s, f) {
      if (E(s)) {
        ...
        if (!O(f) && !E(f) && !L(f))
          throw new TypeError();
        return L(f) && (f = void 0), s = I(s), re(a, o, s, f);
      }
    }
    t("decorate", Ft);
    function Jt(a, o) {
    ...
    function Xt(a, o, s, f) {
      if (!O(s))
        throw new TypeError();
      return E(f) || (f = I(f)), dt(a, o, s, f);
    }
    t("defineMetadata", Xt);
    function qt(a, o, s) {
      if (!O(o))
        throw new TypeError();
      return E(s) || (s = I(s)), lt(a, o, s);
    }
    t("hasMetadata", qt);
    function zt(a, o, s) {
      if (!O(o))
        throw new TypeError();
      return E(s) || (s = I(s)), k(a, o, s);
    }
    t("hasOwnMetadata", zt);
    function Zt(a, o, s) {
      if (!O(o))
        throw new TypeError();
      return E(s) || (s = I(s)), pt(a, o, s);
    }
    t("getMetadata", Zt);
    function Qt(a, o, s) {
      if (!O(o))
        throw new TypeError();
      return E(s) || (s = I(s)), _t(a, o, s);
    }
    t("getOwnMetadata", Qt);
    function kt(a, o) {
      if (!O(a))
        throw new TypeError();
      return E(o) || (o = I(o)), yt(a, o);
    }
    t("getMetadataKeys", kt);
    function te(a, o) {
      if (!O(a))
        throw new TypeError();
      return E(o) || (o = I(o)), wt(a, o);
    }
    ...
    function yt(a, o) {
      ...
      for (var N = 0, Ot = h; N < Ot.length; N++) {
        var w = Ot[N], v = P.has(w);
        v || (P.add(w), _.push(w));
      }
      return _;
    }
    ...
    function ye() {
      ...
      return (
        ...
        function() {
          ...
          return l.prototype.has = function(w) {
            ...
            return v !== void 0 ? Y.has(v, this._key) : !1;
            ...
            return v !== void 0 ? Y.get(v, this._key) : void 0;
      ...
      function h(l, w) {
        if (!n.call(l, s)) {
          if (!w)
            return;
          Object.defineProperty(l, s, { value: Y.create() });
        }
        return l[s];
      }
      function P(l, w) {
      ...
      function d() {
        ...
        for (var w = "", v = 0; v < a; ++v) {
          var N = l[v];
          (v === 4 || v === 6 || v === 8) && (w += "-"), N < 16 && (w += "0"), w += N.toString(16).toLowerCase();
        }
        return w;
      }
    }
...
var xe = Object.defineProperty, M = (e, t) => xe(e, "name", { value: t, configurable: !0 }), C = Yt();
function Nt() {
...
var H, Ne = (H = class {
  constructor(t, n) {
    ...
    */
    ...
    R(this, "modelMap");
    R(this, "emitter");
    this.namespace = t, this.parseModule = n, this.memory = {}, this.state = {}, this.modelMap = /* @__PURE__ */ new WeakMap(), this.emitter = Yt(), typeof window < "u" && (Nt(), Wt(t, this));
  }
  // @ts-expect-error internal
  then(t, n) {
    const r = this.then;
    return this.then = void 0, Lt(...Object.values(this.state)).then(() => t == null ? void 0 : t(this), n).then(() => {
      this.then = r;
    }), this;
  }
  /**
  ...
  init(t) {
    const n = A(t), r = /* @__PURE__ */ M(() => {
      ...
      if (this.emit("Instantiate", {
        ...
        for (const W in p)
          Y[W] = this.init(p[W]);
        g = this.parseModule(new t(...Y));
      } else
        g = this.parseModule(new t());
      return n in this.memory && Object.assign(g, this.memory[n]), typeof window < "u" && (this.emit("Initialize", {
        tag: n
      }), Pt("init", g)), g;
...
}, M(G, "WebBase"), G), Le = Object.defineProperty, m = (e, t) => Le(e, "name", { value: t, configurable: !0 });
function Ue(e, t) {
  const n = `[phecda-vue]: ${e}`;
  t === "error" ? console.error(n) : t === "warn" ? console.warn(n) : console.log(n);
}
m(Ue, "toastMessage");
var Ht = Symbol(void 0), B, We = (B = class extends Ne {
  constructor() {
    super(...arguments);
    R(this, "vueApp");
  }
...
function $e(e) {
  const t = new We("vue", (n) => z(it(n, "shallow") ? me(n) : ge(n), void 0));
...
function ft(e) {
  ...
  }, "dispose"), u = /* @__PURE__ */ m(() => (t++, n || (r = be(!0), n = r.run(() => e())), Te(i), n), "cb");
  return u.r = !0, u;
}
m(ft, "createSharedReactive");
...
function ct() {
  ...
  return b.has(e) || b.set(e, z(e)), b.get(e);
}
m(ct, "usePhecda");
function Je(e) {
}
m(Je, "setStateToComponent");
function ht(e) {
  const t = e || $t("vue");
  if (!t)
    throw new Error("[phecda-vue]:  manually inject the phecda instance if there is no default phecda");
  return b.has(t) || b.set(t, z(t)), b.get(t);
}
m(ht, "getPhecda");
function Xe(e, t) {
  return Me(() => {
    ...
    emit: /* @__PURE__ */ m((n) => C.emit(e, n), "emit"),
    cancel: /* @__PURE__ */ m(() => C.off(e, t), "cancel")
  };
}
m(Xe, "useEvent");
function Gt(e) {
...
function ze(e, t) {
  ...
  const r = {}, i = new Proxy(n, {
    get(u, c) {
      var g;
      if (typeof u[c] == "function" || (g = u[c]) != null && g.__v_skip)
        return u[c];
      const p = r[c];
